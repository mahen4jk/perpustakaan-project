...
class KembaliCon extends Controller
{
    ...
    public function formKembali($idPinjam)
    {
        ...
        // $sirKembali = MdKembali::with('sirPinjam','Anggota','Buku','Denda')->get();

        $Pinjam = DB::table('tb_peminjaman')->where('kode_pinjam', $idPinjam)->get();
        ...
        return view(
            'admin.sirkulasi.formpengembalian',
            compact('kode_kembali','Pinjam','Anggota','Buku','Denda')
        );
    }
