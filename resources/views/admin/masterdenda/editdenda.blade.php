            ...
            <div class="col-lg-auto">
                <div class="card card-success card-outline">
                    <div class="card-header">
                        <h5 class="m-0 bi"> <i class="fa-solid fa-plus"></i>&nbsp;Edit Denda</h5>
                    </div>
                    <div class="card-body">
                        <!-- Form -->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nominal_denda" id="nom_denda"
                                            placeholder="Masukan nominal denda" value="{{ $denda->nominal_denda }}"required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" name="status"
                                                id="customRadio1" value="A"
                                                {{ $denda->status == 'A' ? 'checked' : '' }} required>
                                            <label class="custom-control-label" for="customRadio1">Aktif</label>
                                        </div>
                                        <div class="custom-control custom-radio">
                                            <input class="custom-control-input" type="radio" name="status"
                                                id="customRadio2" value="N"
                                                {{ $denda->status == 'N' ? 'checked' : '' }} required>
