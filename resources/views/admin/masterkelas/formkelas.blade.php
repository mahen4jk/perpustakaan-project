    ...
    <div class="container-fluid">
        <div class="col-lg-auto">
            <div class="card card-success card-outline">
                ...
                <div class="card-body">
                    <!-- Form -->
                    <form action="simpanCLASS" method="POST" id="formKELAS">
                        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                        <div class="form-group row">
                            <label for="staticEmail" class="col-sm-2 col-form-label">Kode Kelas</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="id_kelas" id="id_kelas" placeholder="Kode Kelas" value="{{old('id_kelas')}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="staticKAT" class="col-sm-2 col-form-label">Nama Kelas</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama_kelas" id="nm_kelas" placeholder="Masukan nama kelas" value="{{old('nama_kelas')}}" required>
                            </div>
                        </div>
