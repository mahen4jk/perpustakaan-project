        ...
        <div class="col-lg-auto">
            <div class="card card-success card-outline">
                <div class="card-header">
                    <h5 class="m-0 bi"> <i class="fa-solid fa-plus"></i> Edit Kelas</h5>
                </div>
                <div class="card-body">
                    <!-- Form -->
                    <form action="updateKEL" method="POST" id="formKELAS">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama_kelas" id="nm_kelas" placeholder="Nama Kelas" value="{{$kelas->nama_kelas}}">
                            </div>
                        </div>
