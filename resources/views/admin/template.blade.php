        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              <a href="#" class="nav-link {{ Request::segment(1) === 'master' ? 'active' :null }}">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="#" class="nav-link {{ Request::segment(1) === 'masteranggota' ? 'active' :null }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Master Anggota</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link {{ Request::segment(1) === 'masterkelas' ? 'active' :null }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Master Kelas</p>
                  </a>
                </li>
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{url('buku/masterbuku')}}" class="nav-link {{ Request::segment(1) === 'masterbuku' ? 'active' :null }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Master Buku</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{url('masterkategori')}}" class="nav-link {{ Request::segment(1) === 'masterkategori' ? 'active' :null }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Master Kategori</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link {{ Request::segment(1) === 'masterpenerbit' ? 'active' :null }}">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Master Penerbit</p>
                  </a>
                </li>
